...
internal fun isVendorBootTarget(bootImageKind: String?): Boolean {
    return bootImageKind == BOOT_IMAGE_KIND_VENDOR_BOOT
}
...
internal fun resolveBootImageKindForOutput(bootImageKind: String?): String? {
    return when (bootImageKind) {
        BOOT_IMAGE_KIND_VENDOR_BOOT -> BOOT_IMAGE_KIND_VENDOR_BOOT
        BOOT_IMAGE_KIND_INIT_BOOT -> BOOT_IMAGE_KIND_INIT_BOOT
        BOOT_IMAGE_KIND_BOOT -> BOOT_IMAGE_KIND_BOOT
        else -> null
    }
}
